...
const content = {
  fr: {
    ...
    titleItalic: 'porte',
    desc: 'Sacs artisanaux en cuir, wax, pagnes et tissé fouta. Chaque pièce trace une route — hommage au monde.',
  ...
  en: {
    ...
    titleItalic: 'carry',
    desc: 'Handcrafted bags in leather, wax, pagne and woven fouta. Each piece traces a route — a tribute to the world.',
